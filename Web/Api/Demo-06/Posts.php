...
if($_SERVER['REQUEST_METHOD'] === 'POST')
{
    if($has_id === false)
    {
        require_once('_Posts/01-Create.php');
        die();
    }
}
else if($_SERVER['REQUEST_METHOD'] === 'GET')
{
    if($has_id === false)
    {
        require_once('_Posts/02-Read.php');
        die();
    }
    else
    {
        require_once('_Posts/03-ReadWithId.php');
        die();
    }
}
else if($_SERVER['REQUEST_METHOD'] === 'PUT')
{
    if($has_id === true)
    {
        require_once('_Posts/04-UpdateWithId.php');
        die();
    }
}
else if($_SERVER['REQUEST_METHOD'] === 'DELETE')
{
    if($has_id === true)
    {
        require_once('_Posts/05-DeleteWithId.php');
        die();
    }
}
