        ...
        AsyncTask<String, Void, String> task = new AsyncTask<String, Void, String>()
        {
            ...
            protected void onPreExecute()
            {
                ...
                /*
                    ...
                    ดังนั้น Activity10 ที่สืบทอด AppCompatActivity จึงสามารถเปลี่ยนตัวเองเป็น Context ได้
                    ตามหลัก Polymorphism (https://docs.oracle.com/javase/tutorial/java/IandI/polymorphism.html)
                 */
                context = Activity10.this;
            ...
            protected String doInBackground(String... params)
            {
                ...
                String url = base_url + "/Demo-01/10-PostWithParameter.php";
